...
public class Solution {
    public static void main(String[] args) {
        ...
        System.out.println(getObjectType(new Solution()));
    }
    ...
    public static class Cat extends Solution   //<--Классы наследуются!!
    {
    }
    ...
    public static class Bull extends Solution {
    }

    public static class Cow extends Solution {
    }
